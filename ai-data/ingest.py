...
ALLOWED_FAULT_TYPES = frozenset(
    {
        ...
        "container_oom", "container_cpu_throttle", "linux_oom",
...
FAULT_TYPE_TAGS: dict[str, list[str]] = {
    ...
    "08-linux/process-states": ["zombie_process", "orphan_process"],
    "08-linux/oom-cgroup": ["linux_oom"],
    "08-linux/disk-io": ["disk_io_stress"],
    "08-linux/resource-observation": ["linux_oom", "disk_io_stress"],
