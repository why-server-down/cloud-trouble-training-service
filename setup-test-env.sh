...
echo "   # 또는 venv\\Scripts\\activate.bat  # Windows CMD"
echo "   # 또는 venv\\Scripts\\Activate.ps1  # PowerShell"
...
echo ""
echo -e "${NC}4. 사용 방법:${NC}"
echo "   - 회원가입 후 로그인"
echo "   - 좌측 미션 패널에서 미션 선택 및 시작"
echo "   - 우측 터미널에서 kubectl 명령어로 문제 해결"
echo "   - 완료 확인 버튼으로 미션 검증"
echo ""
echo -e "${CYAN}========================================${NC}"
echo ""
