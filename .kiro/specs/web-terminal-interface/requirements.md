...
### 5. Real-time Collaboration (실시간 협업)
**As a** 학습자  
**I want** 강사나 멘토가 내 터미널을 실시간으로 볼 수 있기를  
**So that** 막힐 때 즉시 도움을 받을 수 있다

**Acceptance Criteria:**
- 5.1 사용자는 터미널 세션 공유 링크를 생성할 수 있다
- 5.2 공유 링크로 접속한 사람은 읽기 전용으로 터미널을 볼 수 있다
- 5.3 공유 모드에서는 실시간으로 명령어 입력과 출력이 동기화된다
- 5.4 공유는 사용자가 언제든지 중단할 수 있다
- 5.5 공유 세션은 30분 후 자동으로 만료된다
